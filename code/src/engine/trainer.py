...
class SingleGPUTrainer:
    def __init__(
        ...
        if continue_config["is_continue"]:
            ...
            self.model.setup(
                train_loader=train_loader, eval_loader=eval_loader, checkpoint=None
            )
    ...
    def train(self):
        ...
        for current_epoch in range(
            ...
            for i, data in enumerate(self.train_loader):
                ...
                if self.checkpointer.time2checkpoint(
...
# Knowledge-Optimization: DistributedDataParallel is better than DataParallel
class DataParallelTrainer:
    def __init__(
        ...
        pass
        # TODO: implement continue train properly by replacing start epoch, etc

    def train(self):
        pass
        # TODO: handling synchronization for multi GPU support
        # TODO: handling parallelization for multi GPU support
        # TODO: handling synchronization for multi GPU support
        # TODO: add summary: the last performance result
        # TODO: add summary: the last performance result
